                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        onPressed: () {
                          // Simple sign-in behaviour for the demo: call the
                          // onLoginSuccess callback if provided. In a real app
                          // you'd validate credentials and call an API.
                          if (onLoginSuccess != null) {
                            onLoginSuccess!();
                          } else {
                            // Fallback behavior: show a SnackBar to indicate
                            // success for local testing.
